  ...
  <q-page class="q-pa-md bg-grey-1">
    ...
    <div class="text-center q-mb-md">
      <q-icon
        ...
        color="pink-3"
      />
      <h4 class="q-mt-none q-mb-sm">{{ project?.name || "Project Kanban" }}</h4>
      <p class="text-subtitle1">All tasks assigned to you in this project</p>
    </div>
...
const logout = () => {
  ...
  router.push("/");
  $q.notify({ color: "positive", position: "top", message: "Logged out successfully!" });
};
</script>
